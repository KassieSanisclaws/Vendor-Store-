...
import { RowData, PieGraphData, ColumnHistory, Data } from "../Types/typeInterface";
...
export default { AboutUsCarouselData,  Rows, PieData, Columns, ColumnsHistory, DataSample, RowsHistory, DataSample2, 
                 ItemDataSample,
};